...
SECRET_KEY = 'oc(kqzj^dto2^h$rtt@v%#3n=sf6x9_176-)icxqt3ap&gv1hn'
...
AUTHENTICATION_BACKENDS = (
    ...
    'social_core.backends.twitter.TwitterOAuth', #!	phone registered, tested and deployed, need privacy URL for email adding
